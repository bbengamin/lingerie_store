<?php
// HTTP
define('HTTP_SERVER', 'http://52.35.91.62/admin/');
define('HTTP_CATALOG', 'http://52.35.91.62/');

// HTTPS
define('HTTPS_SERVER', 'http://52.35.91.62/admin/');
define('HTTPS_CATALOG', 'http://52.35.91.62/');
