...
<header>
  <div class="container">
    ...
    <div class="static-pages-header">
      ...
      <a href="/index.php?route=information/information&information_id=5">ВОПРОСЫ И ОТВЕТЫ</a>
  ...
  <nav id="menu" class="navbar">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown"><a href="<?php echo $category['href']; ?>" onclick="location=this.href;" class="dropdown-toggle" data-toggle="dropdown"><?php echo $category['name']; ?></a>
